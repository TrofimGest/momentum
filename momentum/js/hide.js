...
console.log(`
-------------------
Комментарий: погода срабатывает на эффект блюр(т.е. нужно ввести и после нажать в любое другое место страницы)
-------------------
...
feedback: Можно запустить и остановить, но иконка при этом не меняется
2) настройки приложения сохраняются при перезагрузке страницы 
...
34) ToDo List - список дел (как в оригинальном приложении) или Список ссылок (как в оригинальном приложении) или Свой собственный дополнительный функционал, по сложности аналогичный предложенным 
feedback: Добавлен список ссылок (как в оригинальном приложении)
`)